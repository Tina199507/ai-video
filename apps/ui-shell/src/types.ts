...
export type {
  ...
  SelectorHealth,
  WorkbenchEvent,
} from '@ai-video/shared/types';

/* ---- Pipeline types (single source of truth: shared/types.ts) ---- */

export { SSE_EVENT, WB_EVENT, SUBTITLE_PRESETS, DEFAULT_REFINE_OPTIONS } from '@ai-video/shared/types';
...
export interface VideoProviderConfig {
  ...
  maxWaitMs?: number;
  queueDetection?: import('@ai-video/shared/types').QueueDetectionConfig;
  profileDir: string;
}
