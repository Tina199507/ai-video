...
import { getDashboardStatus, getCardAction } from '@ai-video/shared/dashboardStatus.js';
import type { PipelineProject, PipelineStage, ProcessStatus } from '@ai-video/shared/types.js';
