...
import {
  ...
  BOOT_TRANSITIONS,
  isValidTransition,
} from '@ai-video/shared/bootPhase.js';
...
describe('BootOrchestrator', () => {
  // Dynamic import to avoid module-resolution issues with the desktop app path
  let BootOrchestrator: typeof import('../../../../apps/desktop/src/boot-orchestrator.js').BootOrchestrator;

  beforeEach(async () => {
    const mod = await import('../../../../apps/desktop/src/boot-orchestrator.js');
