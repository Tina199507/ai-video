...
import type { AIAdapter, AIRequestOptions, GenerationResult } from './pipelineTypes.js';
...
import type { TraceContext } from './traceEvents.js';
import { classifyError, makeTraceEvent, createChildContext } from './traceContext.js';
