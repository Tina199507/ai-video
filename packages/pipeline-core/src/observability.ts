...
import type { PipelineStage, LogEntry } from './pipelineTypes.js';
import { ARTIFACT } from './constants.js';
import { stageDurationHistogram } from './metrics.js';
...
export class ObservabilityService {
  ...
  completeStage(projectId: string, stage: PipelineStage, qualityScore?: number): void {
    ...
    stageDurationHistogram.observe(stageMetrics.durationMs / 1000, {
      stage: String(stage),
      status: 'completed',
    });
  }
