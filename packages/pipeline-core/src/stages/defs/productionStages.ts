...
import { isEdgeTTSAvailable, type TTSConfig } from '../../ttsProvider.js';
import type { Scene } from '../../pipelineTypes.js';
...
registerStage({
  ...
  async execute(ctx: StageRunContext) {
    ...
    const { assembleVideo, isFFmpegAvailable } = await import('../../ffmpegAssembler.js');
    ...
    const refineOptions = (project as any).refineOptions as import('../../sharedTypes.js').RefineOptions | undefined;
    ...
    const { getVideoInfo } = await import('../../ffmpegAssembler.js');
