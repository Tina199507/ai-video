...
import type { AIAdapter, Scene, GenerationPlan, LogEntry, StoryboardReplicationSettings, StoryboardReferenceScene } from '../pipelineTypes.js';
...
import { STORYBOARD_SCHEMA } from '../schemaValidator.js';
