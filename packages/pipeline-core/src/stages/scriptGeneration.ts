...
import type { AIAdapter, ResearchData, CalibrationData, NarrativeMap, ScriptOutput, ScriptSkeleton, GenerationPlan, LogEntry } from '../pipelineTypes.js';
...
import { extractAndValidateJSON } from '../responseParser.js';
import { SCRIPT_OUTPUT_SCHEMA } from '../schemaValidator.js';
...
import { sanitizeTranscriptForStyle } from '@ai-video/pipeline-core/libFacade.js';
