...
vi.mock('./chatAutomationSurface.js', () => ({
  ...
  scrapeModels: vi.fn(async () => []),
}));

import { probeSelectors } from './selectorResolver.js';
import { autoDetectSelectors, autoDetectVideoSelectors, cleanupDebugScreenshots } from './chatAutomationSurface.js';
