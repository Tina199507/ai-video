...
import type { AIAdapter } from '@ai-video/pipeline-core/types/adapter.js';
import { installAdapterHostBindings } from '@ai-video/pipeline-core/adapterHostBindings.js';
import { getAdapterHostBindings as getPipelineCoreAdapterHostBindings } from '@ai-video/pipeline-core/hostBindings.js';
import { registerAdapterHostBindings } from './hostBindings.js';

beforeAll(() => {
  installAdapterHostBindings();
  registerAdapterHostBindings(getPipelineCoreAdapterHostBindings());
});
